def get_app_styles() -> str:
    ...
    <style>
        ...
        .workflow-node {
            ...
            transition: all 0.3s; box-shadow: 0 2px 8px rgba(0,0,0,0.08) !important;
        }
        .workflow-node:hover { transform: translateX(5px); }
        ...
        .chat-message-agent {
            background: #f0f2f6;
            color: #000000 !important; padding: 0.8rem 1.2rem;
